...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!(email.equals(""))) {
            ...
            assert ((EditText)findViewById(R.id.textEmail)) != null;
            ((EditText)findViewById(R.id.textEmail)).setText(email);
            assert ((EditText)findViewById(R.id.textPassword)) != null;
            ((EditText)findViewById(R.id.textPassword)).setText(password);
            assert ((CheckBox)findViewById(R.id.rememberMe)) != null;
    ...
    public void OnSignupButtonClick(View v) {
        ...
        Verification verification = BackEnd.verifyEmailAndPassword(email,password);
